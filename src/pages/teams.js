...
import { getTeams, getPlayerHandicaps } from '../firebase';
    ...
    if (authenticated) {
      const loadData = async () => {
        try {
          ...
          const playersData = await getPlayerHandicaps();
          setTeams(teamsData);
      ...
      <div className="home-container">
        ...
        <div className="content">
          ...
          <div className="teams-section mb-8">
            <h2 className="text-3xl font-semibold mb-6 text-center text-success">Teams Overview</h2>
          ...
          <div className="create-matches-section mb-8">
            ...
            {teams.length > 0 ? (
              // Teams data loaded - show match creation interface
              ...
              // Simple loading message instead of skeleton
              <div className="text-center py-4">
                <p className="text-muted">Loading teams data...</p>
              </div>
            )}
          </div>
